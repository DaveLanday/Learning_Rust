...
// Iterators ... 
//
// IntoIter (Consumes the list): 
pub struct IntoIter<T>(List<T>); // Example of a tuple struct
...
// Iter (Does not consume the list. Instead returns immutable references):
pub struct Iter<'a, T> {
...
mod test {
    ...
    fn intoiter(){
        ...
        // Test that IntoIter iterates over the list as expected:
    ...
    fn iter(){
        ...
        // Test that Iter iterates over the list as expected:
        list.push(0); list.push(1); list.push(2);
    ...
    fn itermut(){
        ...
        // Test that IterMut iterates over the list as expected:
        list.push(0); list.push(1); list.push(2);
